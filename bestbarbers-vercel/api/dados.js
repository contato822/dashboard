// api/dados.js — Upstash Redis REST API

const KV_URL   = process.env.KV_REST_API_URL   || "https://star-flea-39622.upstash.io";
const KV_TOKEN = process.env.KV_REST_API_TOKEN  || "AZrGAAIncDE2YTgzZTAzNjM3NWU0ZWE0YWJkOWMxMDAwYTQzNWIyY3AxMzk2MjI";
...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    try {
      const nova = { ...req.body, recebidoEm: new Date().toISOString(), id: Date.now() };
